...
import { ligarRenglon } from '@/app/admin/precios/acciones'
import type { RenglonHuerfano } from '@/app/admin/precios/datos'

/**
 * Los renglones de factura que no se pudieron ligar a un material del catálogo.
 *
 * Es el único trabajo manual del sistema, y encoge cada semana: al resolver uno
 * el alias queda aprendido —«PTR 1X1 CAL.14 6.10M» ya es el PTR para siempre— y
 * ese texto no vuelve a preguntar.
 *
