...
/**
 * Los trazos del imagotipo salen del manual, no de aquí: los extrae
 * `npm run imagotipo` a lib/imagotipo.ts. Se re-exportan para que quien ya
 * pedía el logo a este módulo lo siga encontrando en el mismo sitio.
 */
export {
  LOGO_CAJA,
  LOGO_TRAZO,
